...
public class DropDownListView extends ListView implements OnScrollListener {
	...
	private void getAttrs(Context context, AttributeSet attrs) {
		...
		isAutoLoadOnBottom = ta.getBoolean(R.styleable.drop_down_list_attr_isAutoLoadOnBottom,
				false);
		isShowFooterWhenNoMore = ta.getBoolean(
				R.styleable.drop_down_list_attr_isShowFooterWhenNoMore, true);
		ta.recycle();
	}
}