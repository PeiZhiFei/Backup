 ...
 * 人社服务
 */
public class SiServiceFragment2 extends Fragment implements OnItemClickListener {
	...
	Integer[] siOtherArray = new Integer[] { R.drawable.cjcx, R.drawable.ypml,
			R.drawable.fjwd };
	// String[] s1 = new String[] { "缴费记录", "账户查询", "待遇查询", "缴费申报", "个人信息" };
	String[] s1 = new String[] { "缴费记录", "账户查询", "待遇查询" };
	String[] s2 = new String[] { "收支明细", "余额", "挂失" };
	String[] s3 = new String[] { "成绩查询", "药品目录", "附近网点" };
	SiServiceGridView siCardGridView;

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		View siServiceView = inflater.inflate(R.layout.tab_siservice2test, null);
		// 初始化 社保查询 gridview
		...
		siCardGridView.setAdapter(new SiModulesAdapter(getActivity(),
				siCardImageArray, s2));
		// 初始化 其他 gridview
		SiServiceGridView siOtherGridView = (SiServiceGridView) siServiceView
	...
	public void onResume() {
		...
		new Handler(new Handler.Callback() {
			...
			public boolean handleMessage(Message msg) {
				siCardGridView.getChildAt(2).setVisibility(View.GONE);
				return false;
			}
