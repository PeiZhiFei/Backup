...
import laiyi.tobacco.activity.BaseActivity;

public class UpdateManager
{

    public static final String APP_VERSION_FILE_PATH = "http://www.yanyeapp.com/d/yanyeapp/AppVersion.xml";
    ...
    public UpdateManager(Context context)
    {
        ...
        ((BaseActivity) context).dialogInit();
    }
    ...
    {
        ((BaseActivity) context).dialogProgress();
        new Thread(new Runnable()
        {
            ...
            public void run()
            {
                try
                {
                    InputStream is = new URL(APP_VERSION_FILE_PATH)
                            .openStream();
                ...
                } catch (Exception e)
                {
                    e.printStackTrace();
                    L.l(e.getMessage());
                   dialog((Activity) context, "当前网络不稳定，请重试", false, new onButtonClick() {
                       @Override
