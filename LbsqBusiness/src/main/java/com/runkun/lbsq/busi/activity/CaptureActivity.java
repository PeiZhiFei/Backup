...
import com.runkun.lbsq.busi.zxing.camera.BeepManager;
import com.runkun.lbsq.busi.zxing.camera.CameraManager;
import com.runkun.lbsq.busi.zxing.decode.CaptureActivityHandler;
import com.runkun.lbsq.busi.zxing.decode.DecodeThread;
import com.runkun.lbsq.busi.zxing.decode.FinishListener;
import com.runkun.lbsq.busi.zxing.decode.InactivityTimer;
import com.runkun.lbsq.busi.zxing.view.ViewfinderView;
 ...
 * 条码二维码扫描功能实现
 */
public class CaptureActivity extends BaseAcitivity implements SurfaceHolder.Callback
{
...
//        }, 600);
        ...
        actionbar_right2.setBackgroundResource(R.drawable.star1);
        actionbar_right2.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                // TODO: 2015/8/24  打开手电筒
//                if (!isOpen)
//                {
...
//                isOpen = !isOpen;
                ...
                intent.putExtra ("type", "add_havent");
    ...
    public void search()
    {
        ...
        if (Tools.isEmpty (s))
        {
            Tools.toast (activity, "请输入需要查询的条形码");
            AnimUtil.animShakeText (edit);
        } else
        {
            Intent intent = new Intent (CaptureActivity.this, ResultActivity.class);
            intent.putExtra ("goods_barcode", s);
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor)
    {
        ...
        Intent intent = new Intent (CaptureActivity.this, ResultActivity.class);
        intent.putExtra ("goods_barcode", rawResult.getText ().toString ());
        intent.putExtra ("type", "have");
        startActivity (intent);
        AnimUtil.animToFinish (activity);
