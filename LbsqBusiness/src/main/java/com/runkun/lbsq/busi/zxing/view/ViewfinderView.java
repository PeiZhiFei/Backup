...
package com.runkun.lbsq.busi.zxing.view;
...
public final class ViewfinderView extends View
{
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        cameraManager.setManualFramingRect((int) (Tools.getWidth(getContext()) / 1.2), (int) (Tools.getWidth(getContext()) / 1.8));
//        cameraManager.setTorch(false);
        ...
        } else
        {
            ...
            lineRect.left = frame.left+5;
            lineRect.right = frame.right-5;
