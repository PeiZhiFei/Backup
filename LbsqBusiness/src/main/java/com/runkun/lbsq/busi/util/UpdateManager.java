...
import com.runkun.lbsq.busi.activity.BaseAcitivity;
...
public class UpdateManager
{
    ...
    public static final String APP_VERSION_FILE_PATH = "http://app.lingbushequ.com/update/busi-version.xml";
    ...
    {
        ((BaseAcitivity) context).dialogProgress("加载中……");
