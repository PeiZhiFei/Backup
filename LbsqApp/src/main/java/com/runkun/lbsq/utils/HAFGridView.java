...
public class HAFGridView extends GridView {
	...
	private static class FixedViewInfo {
		/**
		 * The view to counter_add to the grid
		 */
		public View view;
	...
	private static final String LOG_TAG = "GAFGridView";
	...
	public HAFGridView(Context context) {
		super(context);
		initHeaderGridView();
	}

	public HAFGridView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initHeaderGridView();
	}

	public HAFGridView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void addHeaderView(View v, Object data, boolean isSelectable) {
		...
		if (adapter != null && !(adapter instanceof HeaderViewGridAdapter)) {
			throw new IllegalStateException(
					"Cannot counter_add header view to grid -- setAdapter has already been called.");
		}
	...
	private class FullWidthFixedViewLayout extends FrameLayout {
		...
		protected void onLayout(boolean changed, int left, int top, int right,
				int bottom) {
			int realLeft = HAFGridView.this.getPaddingLeft() + getPaddingLeft();
		...
		@Override
		protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
			int targetWidth = HAFGridView.this.getMeasuredWidth()
					- HAFGridView.this.getPaddingLeft()
					- HAFGridView.this.getPaddingRight();
