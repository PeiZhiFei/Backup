...
public class PayBaseFragment extends BaseFragment implements View.OnClickListener
{
    ...
    protected AlipayActivity alipayActivity;
    ...
    public void onAttach(Activity activity)
    {
        ...
        alipayActivity = (AlipayActivity) activity;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        totalFees = String.valueOf(alipayActivity.totalFee + alipayActivity.fareInt);
        ...
        fare.setText("￥" + String.valueOf(alipayActivity.fareInt));

        redMoneyv.setText("0张可用优惠券");
        goodMoney.setText(String.valueOf(alipayActivity.totalFee));
    ...
    private void queryUsableCoupon()
    {
        ...
        rp.addQueryStringParameter("member_id", alipayActivity.memberId);

        L.l("member_id==" + alipayActivity.memberId);
        rp.addQueryStringParameter("store_id", alipayActivity.storeIds);
        L.l ("store_id==" + alipayActivity.storeIds);
        rp.addQueryStringParameter("phone_code", Tools.getUDID(fragment));
        // rp.addQueryStringParameter ("phone_code",  "123");

        L.l("phone_code==" + Tools.getUDID(fragment));
    ...
    public void setCoupon(String id, String amount)
    {
        ...
        shMoney.setText("￥" + String.valueOf(Tools.scale(alipayActivity.totalFee + alipayActivity.fareInt - selectedAmount)));
    }
        ...
        switch (v.getId())
        {
            ...
            case R.id.sel_coupon_btn:
                ...
                } else
                {
                    ...
                    cIntent.putExtra("totalFee", String.valueOf(alipayActivity.totalFee));
                    cIntent.putExtra("storeId", alipayActivity.storeIds);
    ...
    {
        dialogProgress("请稍候");
        alipayActivity.createOrder(selectedCouponId, selectedAmount, new RequestCallBack<String>()
        {
            @Override
            public void onSuccess(ResponseInfo<String> responseInfo)
            {
                ...
                try
                {
                    ...
                    if (HttpHelper.isSuccess(resultJson))
                    {
                        ...
                        if (type == 1)
                        {
                            alipayActivity.outTradeNo = orderJson.getString("order_sn");
                            alipayActivity.pay();
                        } else if (type == 2)
                        {
                            outTradeNo = orderJson.getString("order_sn");
                            float payFee = Tools.scale(alipayActivity.totalFee + alipayActivity.fareInt - selectedAmount);
