...
import com.runkun.lbsq.fragment.MyBuyBasefragment;
...
public class MyBuyActivity extends MyBaseActivity {
	...
	protected void onCreate(Bundle paramBundle) {
		...
		radio_first.setText(Tools.getStr(activity, R.string.BUYPAYYES));
		radio_second.setText(Tools.getStr(activity, R.string.BUYPAYNO));
		setTitles(Tools.getStr(activity, R.string.TMYBUY));
		loads1();
	}
