...
import com.runkun.lbsq.fragment.PayBaseFragment;
import com.runkun.lbsq.interfaces.onButtonClick;
import com.runkun.lbsq.pay.PayResult;
import com.runkun.lbsq.pay.SignUtils;
...
//                            AnimUtil.animBackSlideFinish(activity);
                        } else
                        {
                            ...
                            rp.addQueryStringParameter("total_fees", totalFee);
                            rp.addQueryStringParameter("hongbao",
                                    null == redMoney ? "0" : redMoney.substring(1));
                            rp.addQueryStringParameter("pay_type", "1");
                            rp.addQueryStringParameter("shopcarid", shopcarids);
...
//                            AnimUtil.animBackSlideFinish (activity);
    ...
    private void checkOrder()
    {
        ...
        rp.addQueryStringParameter ("phone_code", Tools.getUDID (activity));
...
//        outTradeNo = sp.getString("order_sn", "");
    ...
    public void createOrder(String couponId, int amount, RequestCallBack<String> callBack)
    {
        ...
        rp.addQueryStringParameter("con_address", address);
        rp.addQueryStringParameter("consigner", consigner);
        rp.addQueryStringParameter("conmobile", conmobile);
        rp.addQueryStringParameter("conremark", conremark);
        rp.addQueryStringParameter("store_ids", storeIds);
        rp.addQueryStringParameter("store_id", storeIds);
        rp.addQueryStringParameter("shopcarids", shopcarids);
        rp.addQueryStringParameter("goodsnums", goodsnums);

        rp.addQueryStringParameter("total_fee", String.valueOf(totalFee));
        rp.addQueryStringParameter("cost_score", "0");
        rp.addQueryStringParameter("couponid", couponId);
