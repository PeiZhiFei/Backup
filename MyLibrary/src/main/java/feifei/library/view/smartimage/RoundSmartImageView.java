...
public class RoundSmartImageView extends RoundImage {
				...
				.setOnCompleteHandler(new SmartImageTask.OnCompleteHandler() {
					...
					public void onComplete(Bitmap bitmap) {
						if (bitmap != null) {
							...
							// fadeInDisplay(RoundSmartImageView.this, bitmap);
						} else {
	...
	public static final ColorDrawable TRANSPARENT_DRAWABLE = new ColorDrawable(
			17170445);
	public static final BitmapDrawable TRANSPARENT = new BitmapDrawable();

	public void fadeInDisplay(ImageView paramImageView, Bitmap paramBitmap) {
